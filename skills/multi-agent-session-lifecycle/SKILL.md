...
description: "agent-deck = tmux over Named Pipes。session add/send/watch, TAIL/PING/RAW_INPUT。Use when: agent-deck lifecycle, CP session, tool-agnostic polling, dead pipe recovery"
project: ghostty-win
---
