---
name: terminal-input-tsf-debugging
description: "CLI & Tooling. (Windows TSF Regression Analysis) Use when user mentions: CLI, script, automation, tool, plugin, extension, config."
...
sources: [9e4e06b1-f482-4067-8633-fa88de993d6b, session-2026-03-19T08-53-6733c910, 86e33ced-f323-41de-865a-1ed088fcba99, 4c49d7aa-3fa8-47ec-a183-c199c3abf4a3, c24ccbea-d293-4037-8ac4-c0e6622163b3, dd7b2921-18d4-43e9-9b70-d636e46c5344, 27539c54-c470-44d1-be81-866ab138945e, fe2768a4-9113-4363-954f-fa62f7acc45e, session-2026-03-19T06-22-708ec066, ebcb4915-cc8b-4d0c-b824-66150c8c4129, 3f292985-6699-44e2-b6b4-15b7cdb71bd8, session-2026-03-19T00-21-c0e56b9f, a4c0b267-f8cb-47a8-80b5-8a6cbb69c62e, 22645b87-277a-4561-94a4-886877d8efd2, session-2026-03-19T00-55-e48fc28c, session-2026-03-18T23-58-30cb74bb, session-2026-03-19T06-50-b4190e5b, cad6d765-4fed-4272-9510-e5171d80fc23, 08c0e683-317c-4a50-a212-aa682c82557f, aa0da96a-11bd-4fc6-bf03-89ceb07a43b8, 019d04db-d5f2-7d41-b6e8-997f746b390c, 952919a2-b68b-4083-9b15-60a6cb0e3a57, 019d05fe-b220-7200-8c13-6d7e6dc8b609, ec757810-d889-4790-8432-334956944d19, 873a2658-b340-47cd-afaa-15616524bde9, 68f8b109-c790-43b0-87ce-3d93e2f226c2]
---
...
## 1. Windows TSF Regression Analysis

Text Services Framework (TSF) is brittle in terminal environments; regressions often manifest as 'invisible' issues like missing preedit text or input drift.

### Steps

1. TSF stability cannot be verified by logic alone; it requires empirical comparison against specific 'known-good' historical commits (e.g., comparing against a specific refactor-broken branch).
2. Common TSF failure modes include missing 'preedit' text (IME candidate strings) and 'input drift' where the cursor position desyncs from the TSF focus.
3. When implementing Win32 text selection, cross-referencing established implementations (like Windows Terminal's ControlInteractivity.cpp) provides the necessary ground truth for event handling and clipboard interaction.

### Examples

```
// Compare against bff80779a:src/apprt/winui3/tsf.zig
```
