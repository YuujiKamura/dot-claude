---
name: win32-overlapped-contract
description: "all. (Win32 Overlapped Handle Contract Compliance) Use when user mentions: ."
...
sources: [31cce2f9-922a-4582-b84f-f5bc8d7da6b1, 019d32df-35a8-76e1-b0cc-256439b7febf, 019d31b5-29de-7741-9c33-9ede2eaa900b, b498183c-1134-4922-bc16-44682e071b6c, 019d32fb-f4ca-73d3-bfb5-b4396f5857b8, 019d31c6-ecb0-7630-9158-b005383bcdbe, 22d5a462-2fdc-4e9e-84d9-84d6f501fb6f, e122629d-2f82-4a39-91d5-fdcf479211fe, 643e9f02-59e8-4b74-8f18-b94122458b0d, a1908622-7835-4c49-b57c-5af86d62eeca, c4b6f524-336e-44e3-8f96-35cc9012c90a, 019d31e9-1c41-7942-b823-299e28da3cfe, 019d31d2-2353-7920-b263-568cabd93c62, 38f00943-cf30-4323-9f93-aefca457dfb9, 36d68b82-399e-4d03-b932-cfb7a7e8b96c, 019d330d-20ed-7d40-9172-3917e4cc07bb, e90e48fa-7876-48cc-ba5d-de039d7b2fec, 019d31e3-7b14-7be2-b397-186723bc81f7, 019d31c9-d8e7-78f2-924f-bbfdda20250a, 019d31d9-850d-7682-b6f1-fdba78da1588, 5cfa5177-006a-45bf-9aa5-edd5ed4c5045, 91ab98b8-3e5d-4a8c-af34-ba648d3f5d09, 05e21a92-3925-4032-a107-466dd1ffc323, 994a76ba-0ba1-49d2-bed6-a010d12a9790, 9fee7a94-895c-4fbc-96d5-4441e689350f, 9aa5f514-653b-49f6-b425-9d2f988274cc, 609c58c2-41a5-48be-bcd1-bc0b3ba8f5f0, 019d31cd-4977-7622-95f1-0d49d2ab928d, f2f8b97a-4ccb-4ac3-b059-4d07320b77ab, 019d32dc-d174-77e0-8f74-8548db56e634, a8f21999-2d50-4a80-8d2f-dc3576627e80, 42ed25b3-322c-415d-b21b-5f935d6fa814, 019d31c3-8d83-7b80-bffc-b2347a29d965, 957a772b-7a57-4e93-9404-750a7a83cb6c, 9c60d8ca-3397-4c3b-9195-f5976c3d6c82, 019d31dc-34ca-77e1-a2e0-5180a9639fe5, 019d31c4-42e7-77d0-8d45-5645f5d4db6b, 019d333b-de9c-7982-a936-21654fa87c28, 262248ac-cdbf-43f7-a95d-08f4500a75e0, 311940a6-5e4d-4f52-b408-1115b57af910, 019d31ca-4e77-78e1-bca3-df133e85f9c6]
---
...
## 1. Win32 Overlapped Handle Contract Compliance

Avoiding synchronous calls and incorrect error handling on overlapped handles

### Events

1. Passing a NULL overlapped pointer to WriteFile on a handle opened with FILE_FLAG_OVERLAPPED violates the Win32 API contract and leads to undefined behavior.
2. WriteFile returning 0 with GetLastError != ERROR_IO_PENDING indicates a real failure, but the code was entering a 5-second wait for a signal that would never arrive.
3. User: '問題: result==0でもGetLastError!=ERROR_IO_PENDINGなら本当のエラー。5s待っても永遠にsignal来ない。' [INTERVENTION]

### Examples

```zig
if (result != 0) return;
if (w.GetLastError() != .IO_PENDING) return; // Correct check
const wait = k32.WaitForSingleObject(ev, 5000);
```
...
- `643e9f02`: 問題: result==0でもGetLastError!=ERROR_IO_PENDINGなら本当のエラー。5s待っても永遠にsignal来ない。
