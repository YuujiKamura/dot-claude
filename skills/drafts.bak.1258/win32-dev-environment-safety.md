---
name: win32-dev-environment-safety
description: "CLI & Tooling. (Binary Locking and Build Safety on Windows) Use when user mentions: CLI, script, automation, tool, plugin, extension, config."
...
sources: [019d04db-d5f2-7d41-b6e8-997f746b390c, 873a2658-b340-47cd-afaa-15616524bde9, cad6d765-4fed-4272-9510-e5171d80fc23, 019d05fe-b220-7200-8c13-6d7e6dc8b609, session-2026-03-19T08-53-6733c910, 3f292985-6699-44e2-b6b4-15b7cdb71bd8, session-2026-03-19T00-55-e48fc28c, session-2026-03-18T23-58-30cb74bb, 27539c54-c470-44d1-be81-866ab138945e, fe2768a4-9113-4363-954f-fa62f7acc45e, dd7b2921-18d4-43e9-9b70-d636e46c5344, session-2026-03-19T06-22-708ec066, 86e33ced-f323-41de-865a-1ed088fcba99, ebcb4915-cc8b-4d0c-b824-66150c8c4129, aa0da96a-11bd-4fc6-bf03-89ceb07a43b8, 22645b87-277a-4561-94a4-886877d8efd2, c24ccbea-d293-4037-8ac4-c0e6622163b3, session-2026-03-19T00-21-c0e56b9f, 08c0e683-317c-4a50-a212-aa682c82557f, a4c0b267-f8cb-47a8-80b5-8a6cbb69c62e, 9e4e06b1-f482-4067-8633-fa88de993d6b, 952919a2-b68b-4083-9b15-60a6cb0e3a57, 4c49d7aa-3fa8-47ec-a183-c199c3abf4a3, ec757810-d889-4790-8432-334956944d19, 68f8b109-c790-43b0-87ce-3d93e2f226c2, session-2026-03-19T06-50-b4190e5b]
---
...
## 1. Binary Locking and Build Safety on Windows

On Windows, running binaries are locked by the OS, making 'hot-rebuilding' dangerous for the stability of the development environment.

### Steps

1. Attempting to run a build command (e.g., 'zig build') while the target application is active will cause a file access error and can potentially crash the host environment or terminal.
2. Validation of changes in active terminal projects must be performed only after ensuring the target process is fully terminated.
3. A sharp distinction between repositories (e.g., Ghostty vs a local fork of Windows Terminal) must be maintained in global memory to prevent the AI from searching for files in the wrong codebase.

### Examples

```powershell
# CRITICAL: Close the app before building
Stop-Process -Name "ghostty"
zig build
```
